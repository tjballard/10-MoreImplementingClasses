...
class Line(object):
    ...
    def length(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        length = ((self.end.x - self.start.x) ** 2 + (self.end.y - self.start.y) ** 2) ** (1 / 2)
        return length
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        sum_x = self.start.x + other_line.start.x
        sum_y = self.start.y + other_line.start.y
        sum2_x = self.end.x + other_line.end.x
        sum2_y = self.end.y + other_line.end.y
        return Line(Point(sum_x,sum_y), Point(sum2_x, sum2_y))
